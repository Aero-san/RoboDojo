...
class VisionEncoder(nn.Module):
    ...
    def __init__(self, config: ModelConfig) -> None:
        ...
        # The WCM path consumes ViT's last_hidden_state directly and never
        # reads the pooled output.  ViTModel nevertheless registers a trainable
        # pooler by default, which leaves pooler.dense.{weight,bias} without a
        # gradient and makes DDP fail when find_unused_parameters=False.
