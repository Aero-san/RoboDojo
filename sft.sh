...
G05_ROOT="$PWD/XPolicyLab/policy/G05/GalaxeaVLA" \
G05_CHECKPOINT_ROOT="$PWD/outputs/g05" \
G05_DATA_FORMAT=hdf5 \
G05_DATA_CONFIG=robodojo_hdf5 \
G05_DATASET_ROOT="$PWD/data/RoboDojo/align_blocks/arx_x5/data" \
G05_HDF5_FPS=25 \
G05_HDF5_IMAGE_LAYOUT=auto \
G05_EXP_NAME=RoboDojo-align_blocks-arx_x5-joint-0 \
bash XPolicyLab/policy/G05/train.sh RoboDojo align_blocks arx_x5 joint 0 0,1,2,3 --task-config robodojo_hdf5 --data-format hdf5 --data-config robodojo_hdf5 --dataset-root "$PWD/data/RoboDojo/align_blocks/arx_x5/data" --max-steps 10000 --learning-rate 1e-5 --lr-min-ratio 0.1 --batch-size 16  --init-checkpoint  /mnt/cpfs-E/mingyang/RoboDojo/outputs/recap_g05_hdf5_remote/align_blocks/iteration_01/g05/checkpoints/step_5000.pt
